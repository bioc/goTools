...
% setwd("c:/MyDoc/Projects/madman/Rpacks/goTools/inst/doc")
% Rnwfile<- file.path("c:/MyDoc/Projects/madman/Rpacks/goTools/inst/doc","goTools.Rnw")
...
As shown below, \Robject{affylist} is a list containing 3 vectors of
